...
function Checkout(props){
              ...
              const orderobject = new FormData(); 
                ...
                function handleOrder (){
                  ...
                  axios
                   .post('http://127.0.0.1:5000/order', orderobject , config)
                   .then(response => {
                             // checking status Http 
                             if ( response.status == 200 ){
                                  props.location.pathname("/Confirmation")
                             }
                             else{
      ...
      console.log (props)
      const listItemsCart = props.location.state.listItems
  ...
  <div className="container">
    <form action>
      ...
      <div className="btns">
        <button onClick={(e)=> handleOrder()}> Purchase </button>
